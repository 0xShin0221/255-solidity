...
contract Donate {
    ...
    function secretFunction(string memory f) external {
        console.logBytes(bytes(f));
        console.logBytes("0x097798381ee91bee7e3420f37298fe723a9eedeade5440d4b2b5ca3192da2428");
        console.logBytes32(0x097798381ee91bee7e3420f37298fe723a9eedeade5440d4b2b5ca3192da2428);
        require(
            keccak256(bytes(f)) !=
